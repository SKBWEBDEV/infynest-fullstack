...
export default function NewArrivals() {
  ...
  const infiniteProducts = [...newArrivals, ...newArrivals, ...newArrivals];
  ...
  useEffect(() => {
    ...
    if (container) {
      ...
      container.scrollLeft = cardWidth * newArrivals.length;
    }
  }, [newArrivals.length]);
  ...
  const handleScroll = () => {
    ...
    const cardWidth = 320 + 24;
    const singleSetWidth = cardWidth * newArrivals.length;
    ...
    <div className="w-full py-12 bg-white overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-8 flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4">
        <div>
          ...
          <p className="text-gray-500 mt-1 text-sm">Fresh styles just landed for you</p>
        </div>
