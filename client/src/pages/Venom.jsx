  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        ...
        const response = await API.get("/products?category=venom");

        console.log("Venom products:", response.data);
        ...
        console.error("Failed to fetch Venom products:", error);

        if (mounted) {
          setProducts([]);

          toast.error(
            error?.response?.data?.message || "Failed to load Venom products",
          );
        }
      } finally {
        if (mounted) {
              ...
              >
                ...
                <Link to={`/product/${productId}`} className="block">
                  ...
                  >
                    ...
                    <img
                      src={image}
                      alt={product.name || "Venom Product"}
                      loading="lazy"
                      className="
                        w-full
                        h-full
