...
export default function EditProduct() {
  ...
  const [minWholesaleQty, setMinWholesaleQty] =
    useState("1");
  ...
  const handleSubmit = async (
    ...
    try {
      ...
      if (
        ...
        // Empty value makes backend set null
        data.append(
          "discountPrice",
          "",
        );
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-gray-500 mt-1.5">
                    Changing this updates current stock only. Initial stock and sold quantity remain unchanged.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#1e222d] border border-gray-800 rounded-2xl p-4 sm:p-5">
              ...
              <div className="mb-4">
                ...
                <p className="text-[10px] text-gray-500 mt-1">
                  Update additional product specifications.
                </p>
            ...
            <div className="space-y-4 bg-[#1e222d] p-4 sm:p-5 rounded-2xl border border-gray-800">
              ...
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-gray-500 mt-1">
                    Keep existing images or replace them using image URLs.
                  </p>
                </div>
              ...
              "file" ? (
                <div>
                  ...
                  {images.length >
                    ...
                    <p className="text-[11px] text-purple-400 mt-2 font-medium">
                      ...
                      new file(s) selected. Existing images will remain.
                    </p>
                  )}
                ...
                <div>
                  ...
                  <p className="text-[10px] text-gray-500 mt-1.5">
                    Current image URLs are loaded above. Edit them to replace the image list.
                  </p>
