// File Path: src/pages/SpiderMan.jsx
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        ...
        const response = await API.get("/products?category=spider-man");

        console.log("Spider-Man products:", response.data);
        ...
        console.error("Failed to fetch Spider-Man products:", error);
        ...
        if (mounted) {
          ...
          toast.error(
            error?.response?.data?.message ||
              "Failed to load Spider-Man products",
          );
        }
      } finally {
        if (mounted) {
    ...
    return (
      <section className="py-10">
        <div className="container mx-auto px-4">
          ...
          <div className="py-14 text-center border border-dashed border-gray-300 rounded-xl">
            <p className="text-sm text-gray-500">
              No Spider-Man products available.
            </p>
              ...
              >
                ...
                <Link to={`/product/${productId}`} className="block">
                  ...
                  >
                    ...
                    <img
                      src={image}
                      alt={product.name || "Spider-Man Product"}
                      loading="lazy"
                      className="
                        w-full
                        h-full
