...
export default function AdminDashboard() {
  ...
  return (
    <div className="flex h-screen bg-[#0f1115] text-gray-200 font-sans overflow-hidden">
      {/* 1. Left Sidebar */}
      <aside
        className={`bg-[#161920] border-r border-gray-800/60 flex flex-col py-6 justify-between z-20 transition-all duration-300 ${isSidebarOpen ? "w-64 px-6" : "w-20 px-3"}`}
      >
        <div className="flex flex-col gap-8">
          {/* Logo / Brand & Toggle Button Area */}
          ...
          <nav className="flex flex-col gap-3">
            ...
            <Link
              ...
              title="Products">
              <HiViewGrid size={22} className="flex-shrink-0 text-purple-400" />
            ...
            <Link 
  to="/admin/orders" 
  className="flex items-center gap-3 px-4 py-3 rounded-xl text-gray-300 hover:bg-purple-600/20 hover:text-purple-400 transition">
  <HiClipboardList className="text-xl" />
  <span className="font-medium text-sm">Orders</span>
</Link>

            {/* Visit Website / Home Option */}
            <Link 
              to="/" 
              className={`flex items-center gap-4 p-3 rounded-xl text-gray-400 hover:bg-gray-800/50 hover:text-white transition cursor-pointer`}
              title="Visit Website"
            >
              <HiHome size={22} className="flex-shrink-0 text-purple-400" />
      ...
      <div className="flex-1 flex flex-col overflow-y-auto">
        ...
        <header className="h-20 px-8 flex items-center justify-between border-b border-gray-800/60 bg-[#0f1115]/80 backdrop-blur-md sticky top-0 z-10">
          ...
          <div className="flex items-center gap-6">
            <h2 className="text-sm font-semibold tracking-wider text-gray-400 italic">
        ...
        <main className="p-8 space-y-8">
          ...
          <div>
            ...
            <p className="text-xs text-gray-400 mt-1">
              Here is what's happening with your store users today.
            </p>
          </div>

          {/* Top 3 Gradient Stat Cards */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="p-6 rounded-3xl bg-gradient-to-r from-amber-300 to-yellow-400 text-gray-900 flex justify-between items-center shadow-lg shadow-yellow-500/10">
              <div>
                ...
                <h3 className="text-3xl font-black mt-1">{adminCount}</h3>
                <span className="text-xs font-semibold underline mt-3 inline-block">
                  Privileged roles
                </span>
              </div>
            ...
            <div className="p-6 rounded-3xl bg-gradient-to-r from-fuchsia-400 to-pink-500 text-white flex justify-between items-center shadow-lg shadow-pink-500/10">
              <div>
                ...
                <h3 className="text-3xl font-black mt-1">{customerCount}</h3>
                <span className="text-xs font-semibold underline mt-3 inline-block">
                  Regular users
                </span>
              </div>
          ...
          {/* Bottom Section: Real Customer/User Management Table */}
            ...
            <div className="flex justify-between items-center mb-6">
              <div>
                ...
                <p className="text-[11px] text-gray-400">
                  View, search and manage store registered users
                </p>
              </div>
              <div className="flex gap-2">
                <button className="px-3.5 py-2 bg-[#1e222d] text-gray-300 rounded-xl text-xs font-semibold border border-gray-700/50 hover:bg-gray-800 transition cursor-pointer">
                  Filter
                </button>
                <button className="px-3.5 py-2 bg-[#1e222d] text-gray-300 rounded-xl text-xs font-semibold border border-gray-700/50 hover:bg-gray-800 transition flex items-center gap-1.5 cursor-pointer">
