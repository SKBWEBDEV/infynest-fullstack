// File Path: src/pages/StrangerThings.jsx
...
export default function StrangerThings() {
  ...
  // ==========================================
  // FETCH STRANGER THINGS PRODUCTS
  // ==========================================
  useEffect(() => {
    let mounted = true;
    ...
    const fetchProducts = async () => {
      try {
        ...
        const response = await API.get("/products?category=stranger-things");

        console.log("Stranger Things products:", response.data);
        ...
        console.error("Failed to fetch Stranger Things products:", error);
        ...
        if (mounted) {
          ...
          toast.error(
            error?.response?.data?.message ||
              "Failed to load Stranger Things products",
          );
        }
      } finally {
        if (mounted) {
        ...
        <div className="px-4 sm:px-6 lg:px-8">
          ...
          >
            <p className="text-sm text-gray-500">
              No Stranger Things products available.
            </p>
              ...
              >
                ...
                <Link to={`/product/${productId}`} className="block">
                  ...
                  >
                    ...
                    <img
                      src={image}
                      alt={product.name || "Stranger Things Product"}
                      loading="lazy"
                      className="
                        w-full
                        h-full
