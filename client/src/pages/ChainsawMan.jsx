// File Path: src/pages/ChainsawMan.jsx
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        ...
        const response = await API.get("/products?category=chainsaw-man");

        console.log("Chainsaw Man products:", response.data);
        ...
        console.error("Failed to fetch Chainsaw Man products:", error);
        ...
        if (mounted) {
          ...
          toast.error(
            error?.response?.data?.message ||
              "Failed to load Chainsaw Man products",
          );
        }
      } finally {
        if (mounted) {
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <p className="text-sm text-gray-500">
              No Chainsaw Man products available.
            </p>
              ...
              >
                ...
                <Link to={`/product/${productId}`} className="block">
                  ...
                  >
                    ...
                    <img
                      src={image}
                      alt={product.name || "Chainsaw Man Product"}
                      loading="lazy"
                      className="
                        w-full
                        h-full
