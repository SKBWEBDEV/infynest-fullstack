...
const Login = () => {
  ...
  // লগইন সাবমিট হ্যান্ডলার (রোল অনুযায়ী রিডাইরেক্ট লজিক সহ)
  ...
  password,
      ...
      // ব্যাকওয়ার্ড কমপ্যাটিবিলিটির জন্য শুধু টোকেন আলাদা সেভ রাখা যেতে পারে
      if (data.token) {
      ...
      <div className="bg-white w-full max-w-5xl rounded-[36px] shadow-2xl p-4 md:p-6 grid grid-cols-1 lg:grid-cols-2 gap-6 items-center relative z-10">
        ...
        >
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-2">
              <span className="text-xs text-gray-300">{t('dont_have_account')}</span>
              <Link to="/register" className="border border-white/50 px-3.5 py-1.5 rounded-full text-xs font-medium hover:bg-white hover:text-black transition">
                {t('register')}
              </Link>
            </div>
          </div>
          ...
          <div className="flex justify-between items-end">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[11px] text-gray-300">UI & E-commerce Platform</p>
              </div>
            </div>
        ...
        <div className="px-4 md:px-6 py-2 flex flex-col justify-center">
          ...
          <div className="flex justify-between items-center mb-6">
            <h1 className="text-lg font-black text-black tracking-wider">INFYNEST</h1>
            ...
            <div className="flex items-center gap-1 border border-gray-200 px-2 py-1 rounded-lg text-xs font-semibold text-gray-700 bg-gray-50 cursor-pointer">
              <span onClick={() => changeLanguage('en')} className={i18n.language === 'en' ? 'font-bold text-black' : 'text-gray-500'}>EN</span>
              <span>|</span>
              <span onClick={() => changeLanguage('bn')} className={i18n.language === 'bn' ? 'font-bold text-black' : 'text-gray-500'}>BN</span>
            </div>
          </div>

          <div className="mb-6">
            <h2 className="text-2xl md:text-3xl font-black text-gray-900 tracking-tight">{t('sign_in')}</h2>
            <p className="text-xs text-gray-500 mt-0.5">{t('welcome_back')}</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <input 
                ...
                required 
                className="w-full px-4 py-3.5 rounded-xl border border-gray-200 focus:outline-none focus:border-black text-xs bg-gray-50/50 text-gray-800 placeholder-gray-400 transition"
              />
            </div>
            ...
            <div className="relative">
              <input 
                ...
                required 
                className="w-full px-4 py-3.5 pr-10 rounded-xl border border-gray-200 focus:outline-none focus:border-black text-xs bg-gray-50/50 text-gray-800 placeholder-gray-400 transition"
              />
              <button
                type="button"
            ...
            <div className="flex items-center justify-between text-xs">
              <label className="flex items-center gap-2 text-gray-600 cursor-pointer">
                <input type="checkbox" className="rounded border-gray-300 text-[#f53b3b] focus:ring-0" />
                Remember me
              </label>
            ...
            <div className="relative flex py-1 items-center">
              ...
              <span className="flex-shrink mx-4 text-gray-400 text-xs">{t('or')}</span>
              <div className="flex-grow border-t border-gray-200"></div>
            </div>
              ...
              <GoogleLogin
                onSuccess={async (credentialResponse) => {
                  try {
                    ...
                    // গুগল লগইনের ক্ষেত্রেও রোল চেক করা যেতে পারে
          ...
          <div className="mt-6 text-center">
            <p className="text-xs text-gray-500">
              {t('dont_have_account')} <Link to="/register" className="text-[#f53b3b] font-semibold hover:underline">{t('register')}</Link>
            </p>

            <div className="flex justify-center items-center gap-6 mt-4 text-gray-400">
              <a href="#" className="hover:text-black transition"><FaFacebookF size={14} /></a>
              <a href="#" className="hover:text-black transition"><FaTwitter size={14} /></a>
              <a href="#" className="hover:text-black transition"><FaLinkedinIn size={14} /></a>
              <a href="#" className="hover:text-black transition"><FaInstagram size={14} /></a>
            </div>
          </div>
