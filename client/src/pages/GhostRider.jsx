// File Path: src/pages/GhostRider.jsx
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        ...
        const response = await API.get("/products?category=ghost-rider");

        console.log("Ghost Rider products:", response.data);
        ...
        console.error("Failed to fetch Ghost Rider products:", error);
        ...
        if (mounted) {
          ...
          toast.error(
            error?.response?.data?.message ||
              "Failed to load Ghost Rider products",
          );
        }
      } finally {
        if (mounted) {
        ...
        <div className="px-4 sm:px-6 lg:px-8">
          ...
          >
            <p className="text-sm text-gray-500">
              No Ghost Rider products available.
            </p>
              ...
              >
                ...
                <Link to={`/product/${productId}`} className="block">
                  ...
                  >
                    ...
                    <img
                      src={image}
                      alt={product.name || "Ghost Rider Product"}
                      loading="lazy"
                      className="
                        w-full
                        h-full
