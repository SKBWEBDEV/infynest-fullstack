  ...
  if (orderSuccess) {
    return (
      <div className="min-h-screen bg-[#0f1115] flex flex-col items-center justify-center text-center px-6 text-gray-200">
        ...
        <Link
          to="/shop"
          className="px-6 py-3 bg-purple-600 hover:bg-purple-700 text-white text-xs font-bold rounded-xl shadow-lg transition"
        >
          Continue Shopping
        </Link>
      </div>
        ...
        {cart.length === 0 ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-[#161920] border border-gray-800/80 p-6 rounded-3xl space-y-6 h-fit shadow-xl">
              <h2 className="text-base font-black text-white border-b border-gray-800 pb-3">
                Order Summary
              </h2>
              ...
              >
                ...
                <div className="space-y-2 pt-2">
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    <button
                      ...
                      className={`p-2.5 rounded-xl border text-[10px] font-bold transition cursor-pointer ${
                        paymentMethod === "Cash on Delivery"
                          ? "bg-purple-600/20 border-purple-500 text-purple-300"
                          : "bg-[#0f1115] border-gray-800 text-gray-400"
                      }`}
                    >
                      Cash on Delivery
                    </button>
                ...
                {(paymentMethod === "bKash" || paymentMethod === "Nagad") && (
                  <div className="space-y-3 p-3.5 bg-[#0f1115] border border-gray-800 rounded-2xl">
                    <p className="text-[11px] text-purple-400 font-bold leading-relaxed">
                      Please Send Money (৳{totalAmount}) to our {paymentMethod}{" "}
                      Personal Number:
                      <strong className="text-white ml-1">01711223344</strong>
                    </p>
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full py-3.5 bg-purple-600 hover:bg-purple-700 disabled:opacity-60 text-white text-xs font-bold rounded-2xl shadow-lg shadow-purple-600/30 transition cursor-pointer mt-3"
                >
                  {loading
                    ? "Processing Order..."
