      ...
      <div className="min-h-screen bg-[#0f1115] flex items-center justify-center px-4">
        <div className="w-full max-w-md bg-[#161920] border border-gray-800 rounded-3xl p-8 text-center shadow-2xl">
          ...
          <p className="text-xs text-gray-400 leading-relaxed mb-6">
            ...
            your order and will contact you soon for
            confirmation.
          </p>
          ...
          <div className="flex flex-col gap-3">
            ...
            <Link
              to="/shop"
              className="inline-flex items-center justify-center px-6 py-3 bg-gray-800 hover:bg-gray-700 text-white text-xs font-bold rounded-xl transition"
            >
              Continue Shopping
            </Link>
                  ...
                  <div>
                    ...
                    >
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                          ...
                          <button
                            ...
                            className={`text-left p-3 rounded-xl border transition ${deliveryArea ===
                              "inside"
                      ...
                      <button
                        type="submit"
                        disabled={loading}
                        className="w-full py-3.5 bg-purple-600 hover:bg-purple-700 disabled:opacity-60 disabled:cursor-not-allowed text-white text-xs font-bold rounded-2xl shadow-lg shadow-purple-600/20 transition cursor-pointer"
                      >
                        {loading
                          ? "Processing Order..."
