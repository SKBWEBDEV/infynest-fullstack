// File Path: src/pages/Essentials.jsx
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        ...
        const response = await API.get("/products?category=essentials");

        console.log("Essentials products:", response.data);
        ...
        console.error("Failed to fetch Essentials products:", error);
        ...
        if (mounted) {
          ...
          toast.error(
            error?.response?.data?.message ||
              "Failed to load Essentials products",
          );
        }
      } finally {
        if (mounted) {
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <p className="text-sm text-gray-500">
              No Essentials products available.
            </p>
              ...
              >
                ...
                <Link to={`/product/${productId}`} className="block">
                  ...
                  >
                    ...
                    <img
                      src={image}
                      alt={product.name || "Essentials Product"}
                      loading="lazy"
                      className="
                        w-full
                        h-full
