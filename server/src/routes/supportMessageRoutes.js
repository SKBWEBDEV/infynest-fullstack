...
// MARK AS SEEN
router.patch("/messages/:id/seen", async (req, res) => {
  try {
    const { id } = req.params;
    ...
    console.error("Mark Support Message Seen Error:", error);
...
// DELETE BY USER
router.delete("/messages/:id/user", async (req, res) => {
  try {
    const { id } = req.params;

    const deletedMessage = await SupportMessage.findByIdAndUpdate(
      id,
      { deletedByUser: true },
      { new: true }
    );
    ...
    console.error("User Delete Support Message Error:", error);
...
// DELETE BY ADMIN
router.delete("/messages/:id/admin", async (req, res) => {
  try {
    const { id } = req.params;
